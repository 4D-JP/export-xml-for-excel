...
theNewDocumentPath		= GETENV("XLS_DOCUMENT_PATH")

objExcelApplication.DisplayAlerts = False
Set theWorkbook			= objExcelApplication.Workbooks.Open(GETENV("XCEL_DOCUMENT_PATH"))
theWorkbook.SaveAs theNewDocumentPath, 56
